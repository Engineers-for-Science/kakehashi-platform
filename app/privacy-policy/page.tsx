            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="divide-y divide-gray-200">
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  <p>
                    The Kakehashi team is committed to protecting the privacy of our users. This privacy policy outlines our data collection, use, and sharing practices.
                  </p>
                  ...
                  <p>
                    If you have any questions regarding our privacy practices or this policy, please contact us at <a className="underline" href="mailto:kakehashispaceapp@gmail.com">kakehashispaceapp@gmail.com</a>.
                  </p>
                </div>
